            ...
            try {
                if(await argon2.verify(rows[0].password, req.body.password)) {
                    req.session.user = {
                        ...
                        page_bg_color: rows[0].page_bg_color,
                        page_line_color: rows[0].page_line_color,
                        page_text_color: rows[0].page_text_color,
                        high_bg_color: rows[0].high_bg_color,
                        high_text_color: rows[0].high_text_color,
                        high_link_color: rows[0].high_link_color,
                        comment_head_color: rows[0].comment_head_color,
                        comment_user_color: rows[0].comment_user_color,
                        comment_foot_color: rows[0].comment_foot_color,
