...
app.use('/settings/colors/', require('./src/routes/user-settings-colors'))
...
app.use('/settings/groups/', require('./src/routes/user-settings-groups'))
app.use('/settings/group/', require('./src/routes/user-settings-group'))
...
app.use('/following/', require('./src/routes/following'))
