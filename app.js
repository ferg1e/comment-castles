...
app.use('/contact-us/', require('./src/routes/contact-us'))
app.use('/api/', require('./src/routes/api-docs'))
...
app.use(/^\/t\/([a-z0-9-]{3,20})$/, require('./src/routes/hashtag-posts'))
...
app.use(/^\/dm\/([a-z0-9]{22})\/edit$/i, require('./src/routes/single-dm-edit'))
app.use(/^\/dm\/([a-z0-9]{22})\/delete$/i, require('./src/routes/single-dm-delete'))
app.use('/api/v1/', require('./src/routes/api'))
app.use('/api/ajax/', require('./src/routes/ajax'))
app.use('/oauth/authorize/', require('./src/routes/oauth-authorize'))
app.use('/oauth/token/', require('./src/routes/oauth-token'))
